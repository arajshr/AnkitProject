...
import pageObjectRepository.historicalReports.ClientPriorityTrackingReport;
...
public class ClientPriorityTracking extends Configuration
{
	...
	@Test(groups= {"REG"})
	public void verify_ClientPriorityTracking_Report()
	{
		int executableRowIndex = excel.isExecutable("verify_ClientPriorityTracking_Report");		
		...
		objDashboard.navigateTo_HistoricalReport().navigateTo_ClientPriorityTracking_Report();
